...
\begin{figure}[H]
\begin{center}
\subfloat[][Főablak]{\label{fig:windowprimary}\includegraphics[height=0.35\linewidth]{images/window-primary.png}}
\hspace{12pt}
\subfloat[][Dialógus]{\label{fig:windowdialogl}\includegraphics[height=0.35\linewidth]{images/window-dialog.png}}
