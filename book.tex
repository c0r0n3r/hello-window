...
pdfsubject={Felhasználói felület fejlesztés és tesztelés GTK környezetben},
...
\title{
Hello Window!\\\medskip
\large{Felhasználói felület fejlesztés és tesztelés \textit{GTK} környezetben}
}
...
\chapter{Felhasználói felületek létrehozása}
