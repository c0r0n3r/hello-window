...
pdfsubject={GTK alapú felhasználói felületek C, C++, Python nyelvű fejlesztése és tesztelése},
pdfkeywords={GTK} {GTK+} {gtkmm} {PyGobject} {GNOME} {Human Interface Guideline} {Dogtail} {Linux},
pdfborder={0, 0, 0},
unicode={true},
colorlinks={false},
a4paper={true}
...
\input{article_intro_gtk_content}
...
\input{article_concept_content}

\chapter{Szignálkezelés dióhéjban}
\input{article_basics_content}
