...
Ez rész a Jelen rész a \textit{GTK+} . Ehhez egy új példprogramot veszünk górcsõ alá, mely forráskódját tekintve némiképp ugyan bonyolultabb az elõzõ részben tárgyalttól, mûködésére nézve azonban nem sokban különbözik tõle.
